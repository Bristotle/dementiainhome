...
export default function HomeView({ cities, featuredGuides = [] }: { cities: City[]; featuredGuides?: RelatedGuideLink[] }) {
 ...
 state programme - not a general article with a place name dropped in.
 </p>
 </div>
 ...
 <Link href="/cities" className="block text-teal-400 font-semibold hover:text-teal-300 transition-colors">All cities →</Link>
 </div>
 </div>
 <div>
