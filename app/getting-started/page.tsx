    ...
    <main className="min-h-screen bg-warm-white">
      ...
      <section className="bg-slate-50 border-b border-slate-200 py-20 bg-soft-wash">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">Free 72-Hour Matching in 4 Simple Steps</h1>
          <p className="text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto">Getting matched with a vetted dementia caregiver is fast, free, and completely pressure-free. Here&apos;s exactly what happens after you reach out.</p>
        </div>
      </section>
