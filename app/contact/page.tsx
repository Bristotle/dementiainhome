        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <FadeIn>
            ...
            <Stagger className="space-y-6 mb-8">
              {[
                { icon:Phone, label:"Call or text", value:"(786) 432-5758", href:"tel:+17864325758", note:"A real person answers, not a bot or a voicemail tree" },
                ...
                { icon:Clock, label:"Hours", value:"Monday to Sunday: 8AM - 9PM", href:null, note:"Urgent placement enquiries are picked up outside these hours" },
              ].map((item) => (
